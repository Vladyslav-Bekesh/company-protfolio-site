export const uk = {
  ...
  hero: {
    title: 'Привіт, я [Ваше Ім\'я]',
    subtitle: 'Розробник, дизайнер та креативна людина',
    cta: 'Дізнатися більше',
  },
  about: {
    title: 'Про мене',
    description: 'Я - досвідчений розробник з пристрастю до створення красивих та функціональних цифрових продуктів.',
    values: {
      title: 'Мої принципи',
