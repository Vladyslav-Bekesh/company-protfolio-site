        ...
        >
          ...
          <Box sx={{ gridColumn: { xs: "1", md: "1" } }}>
            <Box sx={{ mb: 3 }}>
              ...
              >
                Я - досвідчений розробник та дизайнер, який створює інноваційні
                цифрові рішення. Моя мета - допомогти бізнесу та людям досягти
                успіху в цифровому світі.
              </Typography>
          ...
          {footerSections.map((section, index) => (
            <Box
              key={index}
              sx={{ gridColumn: { xs: "1", md: String(index + 2) } }}
            >
              <Box sx={{ mb: 3 }}>
                <Typography
                  variant="h6"
